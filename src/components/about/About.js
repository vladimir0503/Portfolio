      ...
      <AboutBlock>
        <AboutContent>
          ...
          <ScrollAnimation animateIn="fadeIn" animateOnce={true} delay={500}>
            <P>
              Немного о себе. Всегда привлекала IT сфера, а именно веб-разработка. Решил кардинально
              сменить род деятельности. Имею опыт адаптивной верскти и разработки SPA-приложений на
              React.{' '}
            </P>
          </ScrollAnimation>
